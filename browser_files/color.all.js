/* MIT license */
// https://raw.github.com/harthur/color-convert/master/conversions.js
//
...
(function() {
  ...
  window.color_convert = {
    ...
    hsl : {
      rgb: hsl2rgb,
      hsv: hsl2hsv,
      cmyk: function(args) { return rgb2cmyk(hsl2rgb(args)); },
      keyword: function(args) { return rgb2keyword(hsl2rgb(args)); }
    },

    hsv : {
      rgb: hsv2rgb,
      hsl: hsv2hsl,
      cmyk: function(args) { return rgb2cmyk(hsv2rgb(args)); },
      keyword: function(args) { return rgb2keyword(hsv2rgb(args)); }
    },

    cmyk : {
      rgb: cmyk2rgb,
      hsl: function(args) { return rgb2hsl(cmyk2rgb(args)); },
      hsv: function(args) { return rgb2hsv(cmyk2rgb(args)); },
      keyword: function(args) { return rgb2keyword(cmyk2rgb(args)); }
    },

    keyword : {
      rgb: keyword2rgb,
      hsl: function(args) { return rgb2hsl(keyword2rgb(args)); },
      hsv: function(args) { return rgb2hsv(keyword2rgb(args)); },
      cmyk: function(args) { return rgb2cmyk(keyword2rgb(args)); }
    },
...
/* MIT license */
// https://raw.github.com/harthur/color-string/master/color-string.js
//
...
(function() {
  ...
  function getRgba(string) {
     ...
     if (match) {
        ...
        rgb = color_convert.keyword2rgb(match[1]);
        if (!rgb) {
           return;
        }
     }
  ...
  function keyword(rgb) {
     return color_convert.rgb2keyword(rgb.slice(0, 3));
  }
...
/* MIT license */
// https://raw.github.com/harthur/color/master/color.js
//
(function() {
  ...
  var Color = {
    init: function(cssString) {
       ...
       if (typeof cssString == "string") {
          var vals = color_string.getRgba(cssString);
          if (vals) {
             this.setValues("rgb", vals);
          }
          else if(vals = color_string.getHsla(cssString)) {
    ...
    setValues : function(space, vals) {
       ...
       for (var sname in spaces) {
          if (sname != space) {
             this.values[sname] = color_convert[space][sname](this.values[space])
          }
  ...
  window.Color = function(cssString) {
     return new Color.init(cssString);
  };
